    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-6">
                ...
                <!-- Tombol Aksi -->
                <div class="space-y-4">
                    <button class="w-full bg-red-500 hover:bg-red-600 text-white py-3 rounded-lg font-semibold transition">Tambah ke Keranjang</button>
                    <button class="w-full bg-white border border-red-500 text-red-500 hover:bg-red-50 py-3 rounded-lg font-semibold transition">Beli Sekarang</button>
                </div>
            </div>
        </div>
